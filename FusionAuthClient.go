...
func (c *FusionAuthClient) Login(request interface{}) (interface{}, error) {
	...
	body = request
	req, err := c.NewRequest(method, uri, body)
	req.Header.Set("User-Agent", "TotallyEzyServer/0.0.2")
	req.Header.Set("Content-Type", "application/json")
	if c.TenantId != "" {
...
func (c *FusionAuthClient) Register(userId string, request interface{}) (interface{}, error) {
	...
	body = request
	req, _ := c.NewRequest(method, uri, body)
	req.Header.Set("Content-Type", "application/json")
	req.Header.Set("Authorization", c.APIKey)
	if c.TenantId != "" {
		req.Header.Set("X-FusionAuth-TenantId", c.TenantId)
	...
	var resp interface{}
	realResponse, err := c.Do(req, &resp)
	if err == nil {
...
func (c *FusionAuthClient) RetrieveUserByEmail(encodedJWT string, email string) (interface{}, error) {
	var body interface{}
	uri := "/api/user"
	method := http.MethodGet
	req, err := c.NewRequest(method, uri, body)
